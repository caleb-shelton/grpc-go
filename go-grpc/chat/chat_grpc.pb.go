...
const (
	...
	ChatService_SayHelloTwo_FullMethodName = "/chat.ChatService/SayHelloTwo"
)
...
type ChatServiceClient interface {
	...
	SayHelloTwo(ctx context.Context, in *NumberMessage, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *chatServiceClient) SayHelloTwo(ctx context.Context, in *NumberMessage, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, ChatService_SayHelloTwo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	...
	SayHelloTwo(context.Context, *NumberMessage) (*Response, error)
}
...
func (UnimplementedChatServiceServer) SayHelloTwo(context.Context, *NumberMessage) (*Response, error) {
...
func _ChatService_SayHelloTwo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NumberMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).SayHelloTwo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_SayHelloTwo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).SayHelloTwo(ctx, req.(*NumberMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ChatService_SayHelloTwo_Handler,
		},
	},
